...
MSG_TOPUP = (
    ...
    "🆓 Free Tier: ៥ ដង/ថ្ងៃ\n"
    "⭐ Premium: ១ ដង = ០.០២៥$ (ឬ ១ កាក់)\n\n"
    "📲 សូមស្កេន QR Code ខាងក្រោមដើម្បីបង់ប្រាក់ រួចផ្ញើវិក្កយបត្រ (វិក័យប័ត្រ) និង /id របស់អ្នកទៅកាន់ Admin @YourAdminHandle ដើម្បីបញ្ចូលកាក់។"
)

MSG_ID = "🔑 Telegram ID របស់អ្នកគឺ: `{}`"

MSG_ADMIN_ADD = "✅ បានបញ្ចូលចំនួន {amount} កាក់ ទៅកាន់ ID {user_id} ដោយជោគជ័យ។ ទឹកប្រាក់សរុប: {balance} កាក់"
MSG_ADMIN_REMOVE = "✅ បានដកចំនួន {amount} កាក់ ពី ID {user_id} ដោយជោគជ័យ។ ទឹកប្រាក់នៅសល់: {balance} កាក់"
...
MSG_QUOTA_EXCEEDED = (
    "🚫 អ្នកបានប្រើគ្រប់ ៥ ដងសម្រាប់ថ្ងៃនេះហើយ (Free Tier)!\n\n"
